...
public class Ocenka {
    public static void main(String[] args) {
        ...
        System.out.println("Vnesete gi bodovite koi gi osvojil studentot");
        bodovi = tastatura.nextDouble();

        procent = bodovi / max * 100;

        if (bodovi > max) {
            System.out.println("Studentot gi nadminal standardite, no za zal tolku poeni nemoze da se dobijat");
            System.exit(0);
        }
    ...
    System.out.println("studentot dobil 8");
        ...
        System.out.println("Odlicno zavrsena zadaca");
    }
}
